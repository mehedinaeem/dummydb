...
-- part A:
-- 1.Find the name of all instructors whose name starts with "S":
...
-- part B
-- 1. Find the total number of instructors who teach a course in the Spring 2017 semester:

SELECT COUNT(DISTINCT teaches.ID) AS total_instructors
FROM teaches
...
-- 2. Find the names of all instructors who have a higher salary than some instructor in "Comp. Sci":
...
-- 3. Write an SQL query to insert an instructor named John in the Biology department with instructor ID 10211 and a salary of $66,000:

INSERT INTO instructor (ID, name, dept_name, salary)
VALUES (10211, 'John', 'Biology', 66000);
...
-- 2. Find the names of all instructors whose salary is greater than the salary of all instructors in the Biology department:
...
-- 3.Delete all instructors with a salary between $13,000 and $15,000:

SET SQL_SAFE_UPDATES = 0; -- before delete need to off safe mode
